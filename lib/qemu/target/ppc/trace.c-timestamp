...
uint16_t _TRACE_KVM_HANDLE_DRC_READ_DSTATE;
...
TraceEvent _TRACE_KVM_HANDLE_DRC_READ_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "kvm_handle_drc_read",
    .sstate = TRACE_KVM_HANDLE_DRC_READ_ENABLED,
    .dstate = &_TRACE_KVM_HANDLE_DRC_READ_DSTATE 
};
...
TraceEvent *target_ppc_trace_events[] = {
    ...
    &_TRACE_KVM_HANDLE_DRC_READ_EVENT,
