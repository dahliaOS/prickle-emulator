...
extern TraceEvent _TRACE_XEN_BUS_WATCH_EVENT;
...
extern uint16_t _TRACE_XEN_BUS_WATCH_DSTATE;
...
#define TRACE_XEN_BUS_WATCH_ENABLED 1
...
static inline void _nocheck__trace_xen_bus_add_watch(const char * node, const char * key, char * token)
{
    if (trace_event_get_state(TRACE_XEN_BUS_ADD_WATCH) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:xen_bus_add_watch " "node: %s key: %s token: %s" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , node, key, token);
    }
...
static inline void trace_xen_bus_add_watch(const char * node, const char * key, char * token)
{
    if (true) {
        _nocheck__trace_xen_bus_add_watch(node, key, token);
    }
}
...
static inline void _nocheck__trace_xen_bus_remove_watch(const char * node, const char * key, char * token)
{
    if (trace_event_get_state(TRACE_XEN_BUS_REMOVE_WATCH) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:xen_bus_remove_watch " "node: %s key: %s token: %s" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , node, key, token);
    }
...
static inline void trace_xen_bus_remove_watch(const char * node, const char * key, char * token)
{
    if (true) {
        _nocheck__trace_xen_bus_remove_watch(node, key, token);
    }
}

#define TRACE_XEN_BUS_WATCH_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_XEN_BUS_WATCH) || \
    false)

static inline void _nocheck__trace_xen_bus_watch(const char * token)
{
    if (trace_event_get_state(TRACE_XEN_BUS_WATCH) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:xen_bus_watch " "token: %s" "\n",
                 qemu_get_thread_id(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , token);
    }
...
static inline void trace_xen_bus_watch(const char * token)
{
    if (true) {
        _nocheck__trace_xen_bus_watch(token);
    }
}
