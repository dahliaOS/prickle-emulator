...
uint16_t _TRACE_XEN_BUS_WATCH_DSTATE;
...
TraceEvent _TRACE_XEN_BUS_WATCH_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "xen_bus_watch",
    .sstate = TRACE_XEN_BUS_WATCH_ENABLED,
    .dstate = &_TRACE_XEN_BUS_WATCH_DSTATE 
};
