...
uint16_t _TRACE_PFLASH_READ_DSTATE;
uint16_t _TRACE_PFLASH_WRITE_DSTATE;
uint16_t _TRACE_PFLASH_TIMER_EXPIRED_DSTATE;
uint16_t _TRACE_PFLASH_DATA_READ8_DSTATE;
uint16_t _TRACE_PFLASH_DATA_READ16_DSTATE;
uint16_t _TRACE_PFLASH_DATA_READ32_DSTATE;
...
TraceEvent _TRACE_PFLASH_READ_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pflash_read",
    .sstate = TRACE_PFLASH_READ_ENABLED,
    .dstate = &_TRACE_PFLASH_READ_DSTATE 
};
...
TraceEvent _TRACE_PFLASH_DATA_READ8_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pflash_data_read8",
    .sstate = TRACE_PFLASH_DATA_READ8_ENABLED,
    .dstate = &_TRACE_PFLASH_DATA_READ8_DSTATE 
};
TraceEvent _TRACE_PFLASH_DATA_READ16_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pflash_data_read16",
    .sstate = TRACE_PFLASH_DATA_READ16_ENABLED,
    .dstate = &_TRACE_PFLASH_DATA_READ16_DSTATE 
};
TraceEvent _TRACE_PFLASH_DATA_READ32_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pflash_data_read32",
    .sstate = TRACE_PFLASH_DATA_READ32_ENABLED,
    .dstate = &_TRACE_PFLASH_DATA_READ32_DSTATE 
};
...
TraceEvent *hw_block_trace_events[] = {
    ...
    &_TRACE_PFLASH_READ_EVENT,
    &_TRACE_PFLASH_WRITE_EVENT,
    &_TRACE_PFLASH_TIMER_EXPIRED_EVENT,
    &_TRACE_PFLASH_DATA_READ8_EVENT,
    &_TRACE_PFLASH_DATA_READ16_EVENT,
    &_TRACE_PFLASH_DATA_READ32_EVENT,
