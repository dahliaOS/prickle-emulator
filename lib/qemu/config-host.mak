...
libs_softmmu=-lpixman-1 -lutil -lnuma -lbluetooth -lpng16 -lz -ljpeg -lsasl2 -lgcrypt -lxenctrl -lxenstore -lxenguest -lxenforeignmemory -lxengnttab -lxenevtchn -lxendevicemodel  -llzo2 -lsnappy -lfdt
GIT=git
...
VERSION=4.0.50
PKGVERSION=
SRC_PATH=/home/ender/Dahlia/qemu
...
QEMU_CXXFLAGS= -D__STDC_LIMIT_MACROS -Werror -DHAS_LIBSSH2_SFTP_FSYNC -pthread -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -fPIE -DPIE -m64 -mcx16 -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Wall -Wundef -Wwrite-strings -fno-strict-aliasing -fno-common -fwrapv -std=gnu++98 -Wexpansion-to-defined -Wendif-labels -Wno-shift-negative-value -Wno-missing-include-dirs -Wempty-body -Wformat-security -Wformat-y2k -Winit-self -Wignored-qualifiers -Wtype-limits -fstack-protector-strong -I/usr/include/libpng16 -I$(SRC_PATH)/capstone/include
QEMU_INCLUDES=-iquote $(SRC_PATH)/tcg -iquote $(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/ender/Dahlia/qemu/bin/debug/native/linux-headers -iquote . -iquote $(SRC_PATH) -iquote $(SRC_PATH)/accel/tcg -iquote $(SRC_PATH)/include
AUTOCONF_HOST := 
...
LIBS_TOOLS+=-lutil -lcap-ng -lgcrypt 
PTHREAD_LIB=
EXESUF=
DSOSUF=.so
